...
RDEPEND="${DEPEND}
	...
	laptop-detect? ( app-laptop/laptop-detect )"
...
- Uncomment the line in /etc/cron.d/prey.cron"
	...
	epatch "${FILESDIR}"/${PN}-0.6.3-cron-functions.patch \
		"${FILESDIR}"/${PN}-0.6.3-gtk-ui.patch \
