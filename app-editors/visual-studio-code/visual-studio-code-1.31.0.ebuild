...
SRC_URI="
	x86? ( https://update.code.visualstudio.com/1.31.0/linux-ia32/stable ->  ${P}-x86.tar.gz )
	amd64? ( https://update.code.visualstudio.com/1.31.0/linux-x64/stable -> ${P}-amd64.tar.gz )
	"
